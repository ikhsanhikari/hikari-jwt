...
<html lang="en">
    ...
    <head>
        ...
        <link href="http://103.13.97.241:6002/CDN/ProjectTheme/global/plugins/codemirror/theme/eclipse.css" rel="stylesheet" />
    ...
    public static void main(String[]args){
        System.out.println("Hikari Learning");
                                        ...
                                        function compile() {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    cont = `<pre><code  class="java">` + data.data.code + `</code></pre>`;
                                                    $('#output').html(cont);
                                        ...
                                        function savePattern() {
                                            req = {};
                                            req.pattern = editor.getDoc().getValue();
